...
/**
 * Factory for creating {@link RecordData} instances from Java record
 * {@link Element} values.
 */
@Value
public class RecordDataFactory {
	...
	/**
	 * Creates a {@link RecordData} instance for the given {@link Element},
	 * which is expected to be a record element. The method first checks the
	 ...
	 *
	 * @param element The {@link Element} representing the record for which to
	 *                create the {@link RecordData}. This element is expected to
	 *                be a {@link TypeElement}.
	 * @return A {@link RecordData} instance representing the record.
	 */
	public RecordData create(@NonNull final Element element) {
		final String key = this.elementDataCache.keyFor(element);
		return (RecordData) this.elementDataCache.getOrCompute(key, () ->
	 ...
	 *
	 * @param element The {@link Element} representing the record for which to
	 *                create the {@link RecordData}. This {@link Element} is
	 *                expected to be a {@link TypeElement}.
	 * @return A {@link RecordData} instance representing the record.
	 */
	RecordData createUncached(@NonNull final Element element) {
	 ...
	 * superclass. If the record does not have a superclass or if the superclass
	 ...
	 * record does not implement any interfaces or if the interfaces cannot be
	 * resolved, an empty {@link Set} is returned.
	 *
	 * @param typeElement The {@link TypeElement} for which to resolve the
	 *                    superinterfaces.
	 * @return A {@link Set} of fully qualified interface names representing the
	 *         superinterfaces implemented by the record. If no superinterfaces
