...
class HierarchicalOutputFilepathStrategyTest {

	@Test
	void usesSlashSeparatedQualifiedNamesForTypes() {
		HierarchicalOutputFilepathStrategy strategy =
			new HierarchicalOutputFilepathStrategy();

		assertEquals(
			"com/example/Service/index.md",
			strategy.forClassElement(typeElement("com.example.Service"))
		);
		assertEquals(
			"com/example/Api/index.md",
			strategy.forInterfaceElement(typeElement("com.example.Api"))
		);
	}

	@Test
	void usesSlashSeparatedQualifiedNamesForModuleAndPackage() {
		HierarchicalOutputFilepathStrategy strategy =
			new HierarchicalOutputFilepathStrategy();

		assertEquals(
			"com/example/module/index.md",
			strategy.forModuleElement(moduleElement("com.example.module"))
		);
		assertEquals(
			"com/example/pkg/index.md",
